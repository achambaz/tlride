...
\CommentTok{#>       \}}
\CommentTok{#> <environment: 0xf3ca190>}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>       \}}
\CommentTok{#> <bytecode: 0x104fa668>}
\CommentTok{#> <environment: 0xf3ca190>}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>       \}}
\CommentTok{#> <environment: 0x10837e90>}
\CommentTok{#> }
\CommentTok{#> $Gbar}
\CommentTok{#> function(W) \{}
...
\CommentTok{#> \}}
\CommentTok{#> <environment: 0xecf7498>}
\CommentTok{#> }
\CommentTok{#> $formula}
...
-0.004 (see \texttt{bias\_abc}). In words, the average bias of \(\psi_{n}^{c}\) is of the
