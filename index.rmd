...
```{r cover, fig.width = 6, echo = FALSE}
...
programming language  [R](https://www.r-project.org).  R is widely  used among
statisticians and  data scientists  to develop  statistical software  and data
analysis. 

Regularly, a section  is inserted that proposes exercizes.   Each such section
is indicated by the <span style="color:red">&#9881;</span> symbol.  The symbol
<span  style="color:red">&#9761;</span> also  indicates those  sections whose
content is more involved.
...
[bookdown](https://bookdown.org).           Assuming         that          the
[knitr](https://yihui.name/knitr/) package is installed,  you can retrieve all
the R code by running
