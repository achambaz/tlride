...
realizations are equal to `r bias_d_T` and `r bias_d_F` (both rounded to three
decimal  places ---  see `bias_de`).   On  the other  hand, the  G-computation
...
`r bias_e_T` and `r bias_e_F` (both rounded to three decimal places --- see
...
ANTOINE  --  Utiliser  le  paragraphe ci-dessous  pour  ecrire  transition  et
...
3. Implement G-computation estimator based on well-specified working model.
