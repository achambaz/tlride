...
However, we  find it easier  in the  present context to  fluctuate $\Qbar_{n}$
*directly*  in  $\calQ$, as  opposed  to  *indirectly* through  a  fluctuation
defined in  $\calM$ of a  law compatible  with $\Qbar_{n}$.  The  next section
introduces such a fluctuation.
