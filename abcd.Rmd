...
# Fluctuations, first pass {#smooth-first-pass}
...
\begin{equation}(\#eq:fluct)\frac{dP_{h}}{dP} \equiv 1 + h s, \end{equation}
...
# Revisiting Section \@ref(smooth-first-pass) {#revisiting}
...
As it happens,  influence functions of regular^[We can view  $\psi_{n}$ as the
...
\eqref{eq:score},       the      estimator       $\psi_{n,1/\sqrt{n}}$      of
...
of $\Psi(P)$ with  influence function $\IF$, then it must  be true that $\Psi$
is a smooth
