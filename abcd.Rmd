...
selection  of features  of the  law  $P_{0}$ of  the experiment,  specifically
chosen among  $Q_{0,W}$ (the marginal  law of $W$ under  $P_{0}$), $\Gbar_{0}$
(the  conditional  probability  that  $A=1$   given  $W$  under  $P_{0}$)  and
$\Qbar_{0}$ (the conditional mean of $Y$ given $A$ and $W$ under $P_{0}$). 
...
learned_features_fixed_sample_size <-
  ...
  mutate(Qbar_hat_d = map(obs, ~ estimate_Qbar(., algorithm = working_model_Q_one)),
         Qbar_hat_e = map(obs, ~ estimate_Qbar(., algorithm = kknn_algo, ## bstTree
                                               trControl = kknn_control, ## bstTree
                                               tuneGrid = kknn_grid))) %>% ## bstTree
