...
psi_hat_ab <- obs %>% as_tibble  %>%
  ...
  pivot_longer(c(`est_a`, `est_b`), names_to = "type", values_to = "estimates") %>%
...
psi_hat_de <- learned_features_fixed_sample_size %>%
  select(est_d, est_e) %>%
  pivot_longer(c(`est_d`, `est_e`), names_to = "type", values_to = "estimates") %>%
  ...
  pivot_longer(c(`clt_`, `clt_alt`), names_to = "key", values_to = "clt") %>%
  extract(key, "key", "_(.*)$") %>%
...
psi_hat_de_one_step <- learned_features_fixed_sample_size %>%
  ...
  pivot_longer(c(`os_est_d`, `os_est_e`), names_to = "type", values_to = "estimates") %>%
  extract(type, "type", "_([de])$") %>%
...
psi_tmle <- learned_features_fixed_sample_size %>%
  ...
  pivot_longer(c(`tmle_d`, `tmle_e`), names_to = "type", values_to = "estimates") %>%
  extract(type, "type", "_([de])$") %>%
