...
page --- a little tricky).


### Elementary statistical properties {#elementary-stat-prop-iptw}

Because $\Gbar_{n}$ minimizes the empirical risk over a finite-dimensional and
_well-specified working model_, $\sqrt{n} (\psi_{n}^{c} - \psi_{0})$ converges
in law to a centered Gaussian law.
