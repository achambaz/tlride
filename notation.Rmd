...
reward of action $A$ in context $W$.

- $P$, $P_{0}$, $\Pi_{0}$, $\Pi_{h}$, laws for $O$.

-  $\calM$, the model, that is, the collection of \textit{all} laws from which
$O$ can be drawn and that meet some constraints.
